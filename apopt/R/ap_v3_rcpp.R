#' American Put Option Pricing using Rcpp
#'
#' Prices an American put option using the Cox-Ross-Rubinstein binomial tree model
#' with a C++ implementation for improved performance.
#'
#' @param S0 Initial stock price
#' @param K Strike price
#' @param r Risk-free interest rate compounded continuously
#' @param q Dividend yield compounded continuously
...
#'
#' @examples
#' ap_v3_rcpp(S0 = 40, K = 40, r = 0.08, q = 0, tt = 0.25, sigma = 0.30, steps = 1000)
